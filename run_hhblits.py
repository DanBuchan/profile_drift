...
/home/dbuchan/Applications/hh-suite-3.3.0/build/bin/ffindex_from_fasta -s distance20.fa.ffdata distance20.fa.ffindex distance20.fa
 mpirun -np 2 ~/Applications/hh-suite-3.3.0/build/src/hhblits_mpi -i distance20.fa -d /home/dbuchan/Applications/hhdb/UniRef30_2022_02 -oa3m distance20_a3m_wo_ss -n 2 -cpu 1 -v 0

def build_hhsearch_db(fasta_file):
...
def do_hhblits_iterations(fasta_file, seed_seq, n):
...
build_hhsearch_db(sys.argv[1])
# do_hhblits_iterations(sys.argv[1], sys.argv[2], sys.argv[3])
# blast_hits = parse_hhblits_hits(sys.argv[4])
