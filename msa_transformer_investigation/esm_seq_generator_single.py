# using esm2_t48_15B_UR50D to predict seqs at different levels of masking
...
def generate_seqs(msa, transformer, transformer_alphabet, align_name, mask_amount, fhOut):
    ...
    for seq in seqs:
        ...
        print(name, inputs)
        # exit()
        transformer_batch_labels, transformer_batch_strs, transformer_batch_tokens = transformer_batch_converter([list(inputs)])
...
esm2_transformer, esm2_transformer_alphabet = esm.pretrained.esm2_t33_650M_UR50D()
# esm2_transformer, esm2_transformer_alphabet = esm.pretrained.esm2_t48_15B_UR50D()
...
for name, param in esm2_transformer.named_parameters():
    # print(name)
